...
def test_limit_buy_order_GTT(continuous_market, vega: VegaService, page: Page):
    ...
    # 7002-SORD-017
    expect(page.get_by_role("row").nth(2)).to_contain_text("BTC:DAI_2023Futr10+10LimitFilled120.00GTT:")
...
def test_limit_buy_order(continuous_market, vega: VegaService, page: Page):
    ...
    page.get_by_test_id("All").click()
    # 7002-SORD-017
    expect(page.get_by_role("row").nth(2)).to_contain_text("BTC:DAI_2023Futr10+10LimitFilled120.00GTC")
