...
def test_should_display_info_and_button_for_deposit(continuous_market, vega: VegaService, page: Page):
    ...
    page.get_by_test_id(order_size).type("200000")
    page.get_by_test_id(order_price).type("20")
    # 7002-SORD-060
...
def test_should_show_an_error_if_your_balance_is_zero(continuous_market, vega: VegaService, page: Page):
    ...
    page.reload()
    page.get_by_test_id(order_size).type("200")
    page.get_by_test_id(order_price).type("20")
    # 7002-SORD-060
    page.get_by_test_id(place_order).is_enabled()
    # 7002-SORD-003
