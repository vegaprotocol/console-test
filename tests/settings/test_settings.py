...
ICON_TO_TOAST = {
    'aria-label="arrow-top-left icon"': (
        'class="group absolute z-20 top-0 left-0 max-w-full max-h-full'
        ' overflow-x-hidden overflow-y-auto p-4"'
    ),
    'aria-label="arrow-up icon"': (
        'class="group absolute z-20 top-0 left-[50%] translate-x-[-50%] max-w-full'
        ' max-h-full overflow-x-hidden overflow-y-auto p-4"'
    ),
    'aria-label="arrow-top-right icon"': (
        'class="group absolute z-20 top-0 right-0 max-w-full max-h-full'
        ' overflow-x-hidden overflow-y-auto p-4"'
    ),
    'aria-label="arrow-bottom-left icon"': (
        'class="group absolute z-20 bottom-0 left-0 max-w-full max-h-full'
        ' overflow-x-hidden overflow-y-auto p-4"'
    ),
    'aria-label="arrow-down icon"': (
        'class="group absolute z-20 bottom-0 left-[50%] translate-x-[-50%] max-w-full'
        ' max-h-full overflow-x-hidden overflow-y-auto p-4"'
    ),
    'aria-label="arrow-bottom-right icon"': (
        'class="group absolute z-20 bottom-0 right-0 max-w-full max-h-full'
        ' overflow-x-hidden overflow-y-auto p-4"'
    ),
}
